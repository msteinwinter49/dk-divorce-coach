  ...
  return (
    <div style={S.page}>
      ...
      <div style={S.card}>
        ...
        <p style={{...S.p, marginBottom:0}}>Sessions are available by video or phone. I work with individual parents as well as coparenting pairs who are committed to putting their kids first.</p>
      </div>
