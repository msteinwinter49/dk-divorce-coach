      ...
      <div style={{ padding: mobile ? "2rem 1rem" : "3rem 2rem", maxWidth:800, margin:"0 auto" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns: mobile ? "1fr" : "repeat(2,1fr)", gap:16 }}>
          {[
            ...
            ["You Are Not Alone","My drive to help separating families create positive outcomes comes from multiple personal childhood and adult experiences within separated families. My training as a CDC Certified Divorce Coach, with CDC Specialty Divorce Coach training, qualifies me to offer that support to you."],
